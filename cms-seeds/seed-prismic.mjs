...
const NEWSTICKER_ITEMS = [
  ...
  { slug: "nt-dax-rekordhoch", headline: "DAX schließt mit Rekordhoch bei 24.987 Punkten", href: "/artikel/dax-rekordhoch", topic: "Wirtschaft", isPremium: true },
...
const STOCK_DATA_JSON = JSON.stringify({
  ...
  watchlist: [
    ...
    { id: "bayn", symbol: "BAYN.DE", name: "Bayer AG", price: 48.92, change: -0.73, changePercent: -1.47, marketCap: "48.2B", pe: 8.5, sector: "Pharma" },
  ],
  chartData: {},
});
